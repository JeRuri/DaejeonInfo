package com.abs2432gmail.daejeoninfo.OkHttp;

import android.util.Log;

import com.abs2432gmail.daejeoninfo.Common.DaejeonInfoApplication;
...
public class OkHttpAPICall {
    private static final String TAG = "OkHttpAPICall";
    ...
    public static Response GET(OkHttpClient client, String url) throws IOException {
        ...
        Request request = new Request.Builder()
                .url(url)
                .addHeader("Cookie", DaejeonInfoApplication.getCookie())
                .get()
                .build();
